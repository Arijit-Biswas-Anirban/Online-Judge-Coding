...
// Value to Pay. Remember the space after ":" and after "R$" symbol.
...
int main()
{
    ...
    int product_code1, units_of_product1, product_code2, units_of_product2;
    float one_unit_price_product1, one_unit_price_product2, Valor_a_pagar;

    scanf("%d%d%f", &product_code1, &units_of_product1, &one_unit_price_product1);
    scanf("%d%d%f", &product_code2, &units_of_product2, &one_unit_price_product2);

    Valor_a_pagar = (units_of_product1 * one_unit_price_product1) + (units_of_product2 * one_unit_price_product2);
