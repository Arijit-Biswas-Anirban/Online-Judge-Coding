/*
"Contestant who earns a score equal to or greater than the k-th place finisher's score will advance to the next round, as long
as the contestant earns a positive score..." — an excerpt from contest rules.
...
int func(int n, int k)
{
    ...
    for(int i=0; i<n; i++)
    {
        ...
        else if((i < k && arr[i] >= arr[k - 1]) || (i >= k && arr[i] >= arr[k - 1]))
        {
            cont2++;
        }
    }
